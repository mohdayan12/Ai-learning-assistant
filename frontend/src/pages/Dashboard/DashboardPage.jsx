        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-5'>
          {
            ...
            <div key={index} 
              className='group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-4 hover:shadow-2xl hover:shadow-slate-300/50  transition-all duration-300 hover:-translate-y-1'>
              ...
              <div className='text-3xl font-semibold text-slate-900 tracking-tight '>{stat.value}
              </div>
            </div>
            ))} 
        </div>
         ...
         <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6'>
           ...
           <div className='space-y-3'>
              {[
                ...
                .sort((a,b)=>new Date(b.timestamp) - new Date(a.timestamp)).map((activity,index) =>(
                 ...
                 <div className='flex-1 min-w-0'>
                  ...
                  {activity.link && (
                    <a href={activity.link} className='ml-4 px-4 py-2 text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transtion-all duration-200 whitespace-nowrap'>
                    View </a>
                  )}
                  </div>
                )) }
              ...
              <div className='text-center py-12'>
                ...
                <p className='text-xs text-slate-500 mb-1'>Start learning to see your progress here</p>
              </div>
           )}
         </div>
