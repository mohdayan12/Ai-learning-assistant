    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8">
        <div className="text-center space-y-6">
          ...
          <div>
            <p className="text-slate-600 text-sm font-semibold tracking-wide uppercase mb-2">
              Your Score
            </p>
            <div
            ...
            >
              <div className="flex items-start justify-between gap-4 mb-3 ">
                <div className="flex-1">
                  <div className="bg-slate-50 inline-flex items-center gap-2 px-3 py-1 border border-slate-200 rounded-lg mb-3 ">
