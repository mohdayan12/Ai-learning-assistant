  ...
  return (
    <div className="relative w-full h-72 " style={{ perspective: "1000px" }}>
      ...
      >
        ...
        {/* Back of the card*/}
        <div
          className="absolute w-full h-full inset-0 bg-linear-to-r from-emerald-500 to-teal-500 border-2 border-emerald-400/60 rounded-2xl shadow-xl shadow-emerald-500/30 p-8 flex flex-col justify-between"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",
