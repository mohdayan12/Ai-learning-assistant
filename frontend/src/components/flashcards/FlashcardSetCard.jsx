...
const FlashcardSetCard = ({flashcardSet}) => {
 ...
 const progressPercentage=totalCards>0 ?Math.round((reviewedCount/ totalCards) *100 ):0;
  ...
  return <div className='group relative bg-white/80 backdrop-blur-xl border border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/10 flex flex-col justify-between '
   onClick={handleStudyNow}
  >
  <div className='space-y-4 '>
    <div className='flex items-start gap-4'>
      <div className='shrink-0 w-12 h-12 rounded-xl bg-linear-to-br from-emrald-100 to-teal-100 flex items-center justify-center'>
  ...
  <div className='mt-6 pt-4 border-t border-slate-100 '>
   ...
   className='group/btn relative w-full h-full bg-linear-to-r from-emerald-50 to-teal-100 hover:from-emerald-600 hover:to-teal-600 text-emerald-700 hover:text-white font-semibold text-sm rounded-xl transition-all duration-200 active:scale-95 overflow-hidden '
   >
